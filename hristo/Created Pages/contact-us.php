...
<h3>Contact info</h3>
<hr>
<h4>Or you can contact us directly by filling your details bellow:</h4>
                  <form class="form-horizontal">
                    <div class="form-group">
                      <label for="exampleInputName2">Name</label>
                      <input type="text" class="form-control" id="exampleInputName2" placeholder="Your Full Name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group ">
                     ...
                     <textarea  class="form-control" rows="20" placeholder="Your message to us"></textarea> 
                    </div>
		   ...
		   <div class="col-md-3">
				<div class="panel panel-primary">
					<div class="panel-heading">Promo Ad</div>
